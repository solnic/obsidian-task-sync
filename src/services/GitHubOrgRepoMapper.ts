...
import { GitHubOrgRepoMapping } from "../components/ui/settings/types";
...
export class GitHubOrgRepoMapper {
  ...
  /**
   * Apply organization/repository mappings to import configuration
   * @param repository Repository in format 'owner/repo'
   * @param config Existing import configuration to enhance
   * @returns Enhanced configuration with org/repo mappings applied
   */
  enhanceImportConfig(
    repository: string,
