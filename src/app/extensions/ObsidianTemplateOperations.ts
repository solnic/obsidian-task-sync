...
export class ObsidianTemplateOperations {
   ...
   */
  private detectTemplateType(filePath: string, content: string): "task" | "project" | "area" | "parent-task" | null {
  ...
  private getTemplateNameFromFile(file: TFile): string {
    return file.basename.replace(/[-_]/g, " ").replace(/\b\w/g, l => l.toUpperCase());
  }
