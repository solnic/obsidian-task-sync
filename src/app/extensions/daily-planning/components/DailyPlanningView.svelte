<script lang="ts">
  ...
  import ReviewYesterdayStep from "./ReviewYesterdayStep.svelte";
  import TodayAgendaStep from "./TodayAgendaStep.svelte";
  import PlanSummaryStep from "./PlanSummaryStep.svelte";
