 ...
 */
export class ObsidianTaskOperations extends Tasks.Operations {
  public buildEntity(
 ...
 */
export class ObsidianProjectOperations extends Projects.Operations {
  public buildEntity(
 ...
 * Overrides buildEntity to automatically set source.filePath
 */
export class ObsidianAreaOperations extends Areas.Operations {
  public buildEntity(
 ...
 */
export class ObsidianTodoPromotionOperations {
...
export class ObsidianOperations {
  public readonly tasks: ObsidianTaskOperations;
  public readonly projects: ObsidianProjectOperations;
  public readonly areas: ObsidianAreaOperations;
  public readonly todoPromotion: ObsidianTodoPromotionOperations;
  ...
  constructor(
    ...
    this.tasks = new ObsidianTaskOperations(settings);
    this.projects = new ObsidianProjectOperations(settings);
    this.areas = new ObsidianAreaOperations(settings);
    this.todoPromotion = new ObsidianTodoPromotionOperations(
      app,
      settings,
      contextService,
      this.tasks
