...
export class ScheduleOperations extends BaseEntityOperations<Schedule> {
  public readonly entityType = "schedule" as const;
...
export const scheduleQueries = new ScheduleQueries();
export const scheduleOperations = new ScheduleOperations();
