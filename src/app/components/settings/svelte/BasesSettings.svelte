<script lang="ts">
  ...
  onMount(() => {
    ...
    new Setting(container)
      ...
      .addToggle((toggle) => {
        toggle.setValue(settings.autoGenerateBases).onChange((value) => {
    ...
    new Setting(container)
      ...
      .addToggle((toggle) => {
        toggle.setValue(settings.autoUpdateBaseViews).onChange((value) => {
    ...
    new Setting(container)
      ...
      .addToggle((toggle) => {
        toggle.setValue(settings.areaBasesEnabled).onChange((value) => {
    ...
    new Setting(container)
      ...
      .addToggle((toggle) => {
        toggle.setValue(settings.projectBasesEnabled).onChange((value) => {
