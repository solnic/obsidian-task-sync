...
- [ ] Third todo item`;
    ...
    await openFile(context.page, "Areas/Revert Test.md");
    ...
    await executeCommand(context.page, "Task Sync: Revert Promoted Todo");
    await context.page.waitForTimeout(2000);
...
- [ ] Regular todo item`;
    ...
    await openFile(context.page, "Areas/Completed Revert Test.md");
...
- [ ] Regular todo item`;
    ...
    await openFile(context.page, "Areas/Error Test.md");
