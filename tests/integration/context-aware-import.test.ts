...
describe('Context-Aware Import Integration', () => {
  ...
  let getContextAwareImportConfig: (context: FileContext, settings: any) => TaskImportConfig;
  ...
  beforeEach(async () => {
    ...
    getContextAwareImportConfig = (context: FileContext, settings: any): TaskImportConfig => {
  ...
  it('should detect project context and configure import accordingly', () => {
    ...
    const projectFile = createMockFile('Projects/Mobile App.md', 'Mobile App.md');
