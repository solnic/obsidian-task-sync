...
export async function setupObsidianElectron(
  ...
  const mainJsPath = path.resolve("./tests/e2e/.obsidian-unpacked/main.js");
  const appExtractedMainJs = path.resolve(
    "./tests/e2e/.obsidian-unpacked/app-extracted/main.js"
  );
  const obsidianBinaryPath = path.resolve(
    "./tests/e2e/.obsidian-unpacked/obsidian"
  );
  const appAsarPath = path.resolve(
    "./tests/e2e/.obsidian-unpacked/resources/app.asar"
  );
