...
test.describe("Task Creation", () => {
  ...
  test("should create task with all properties and verify file content", async ({
    ...
    const developmentArea = page
      .locator('[data-testid="property-areas-dropdown-item"]:has-text("Development")')
      .first();
    ...
    const testingArea = page
      .locator('[data-testid="property-areas-dropdown-item"]:has-text("Testing")')
      .first();
    ...
    // Areas should be an array of wiki links
  ...
  test("should show project dropdown and allow project selection", async ({
    ...
    // Association properties store wiki links in format: [[filename.md|DisplayName]]
  ...
  test("should support multi-select areas association and verify in frontmatter", async ({
    ...
    const developmentArea = page
      .locator('[data-testid="property-areas-dropdown-item"]:has-text("Development Area")')
      .first();
    await expect(developmentArea).toBeVisible({ timeout: 3000 });
    await developmentArea.click();
    ...
    const testingArea = page
      .locator('[data-testid="property-areas-dropdown-item"]:has-text("Testing Area")')
      .first();
    await expect(testingArea).toBeVisible();
    await testingArea.click();
    ...
    const documentationArea = page
      .locator('[data-testid="property-areas-dropdown-item"]:has-text("Documentation Area")')
      .first();
    ...
    expect(areaNames).toContain("Documentation Area");
  });
