...
describe("Todo Promotion E2E", () => {
  ...
  test("should promote incomplete todo to task", async () => {
    ...
    await openFile(context.page, "Areas/Personal.md");
  ...
  test("should promote completed todo to task", async () => {
    ...
    // Open the file using helper
    await openFile(context.page, "Projects/Documentation.md");
  ...
  test("should handle indented todo items", async () => {
    ...
    // Open the file using helper
    await openFile(context.page, "Areas/Work.md");
  ...
  test("should show notice when no todo found", async () => {
    ...
    // Open the file using helper
    await openFile(context.page, "Areas/Test.md");
  ...
  test("should work with different list markers", async () => {
    ...
    // Open the file using helper
    await openFile(context.page, "Areas/Mixed.md");
  ...
  test("should set context properties correctly when promoting todo in project", async () => {
    ...
    // Open the file using helper
    await openFile(context.page, "Projects/Website Redesign.md");
  ...
  - [x] Completed child task`;
    ...
    // Open the file using helper
    await openFile(context.page, "Areas/Nested.md");
  ...
  - [ ] Child to promote later`;
    ...
    // Open the file using helper
    await openFile(context.page, "Areas/DoubleLink.md");
  ...
  - [ ] Sub-task to promote`;
    ...
    // Open the file using helper
    await openFile(context.page, "Areas/SubTask.md");
