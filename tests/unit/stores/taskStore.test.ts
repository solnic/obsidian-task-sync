...
GitHub task content`;
    ...
    it('should get tasks by source', async () => {
      ...
      const githubTask1 = new MockTFile('Tasks/GitHub Task 1.md', 'GitHub Task 1');
      const githubTask2 = new MockTFile('Tasks/GitHub Task 2.md', 'GitHub Task 2');
      const linearTask = new MockTFile('Tasks/Linear Task.md', 'Linear Task');
      const regularTask = new MockTFile('Tasks/Regular Task.md', 'Regular Task');

      mockApp.vault.getMarkdownFiles.mockReturnValue([
        githubTask1, githubTask2, linearTask, regularTask
      ]);
